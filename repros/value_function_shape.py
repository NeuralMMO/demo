'''Uncaught error when value function returns wrong tensor shape
Severity: Medium
Description: Custom value functions breaking for wrong data shape (different error from type repo, harder to debug)
Suggested fix: Resolve and add a test for custom value functions in multiagent envs
'''
