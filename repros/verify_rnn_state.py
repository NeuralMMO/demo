...
class Policy(RecurrentNetwork, nn.Module):
    ...
    def get_initial_state(self):
        # Minor: error msg does not explicitly reference the initial state
        return [self.value.weight.new(self.HIDDEN).zero_(),
                self.value.weight.new(self.HIDDEN).zero_()]
    ...
    def value_function(self):
        #Missing flatten, downstream error
